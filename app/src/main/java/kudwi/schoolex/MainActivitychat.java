...
import kudwi.schoolex.adapter.ChatFirebaseAdapter;
import kudwi.schoolex.adapter.ClickListenerChatFirebase;
import kudwi.schoolex.model.ChatModel;
import kudwi.schoolex.model.FileModel;
import kudwi.schoolex.model.MapModel;
import kudwi.schoolex.model.UserModel;
import kudwi.schoolex.util.Util;
import kudwi.schoolex.view.FullScreenImageActivity;
import kudwi.schoolex.view.LoginActivity;
...
public class MainActivitychat extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, View.OnClickListener, ClickListenerChatFirebase {
    ...
    static String CHAT_REFERENCE = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras!=null)
        {
            CHAT_REFERENCE=extras.getString("chattype");
        }

        if (!Util.verificaConexao(this)){
            Util.initToast(this,"Please enable your internet");
            finish();
        }else{
            bindViews();
